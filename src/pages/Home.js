...
// ✅ MOVED OUTSIDE COMPONENT - Static data doesn't need to be recreated
const mockVideos = [
  {
    id: "1",
    ...
    duration: "2:29",
    thumbnail:
      "https://i.ytimg.com/vi/xIqp1wx1tWk/hq720.jpg?sqp=-oaymwEnCNAFEJQDSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLAlqbWDlB6lxp-MaJXKuOgUyGbbvA",
    category: "animation",
    verified: true,
  },
  {
  ...
  },
  {
    ...
    duration: "18:45",
    thumbnail:
      "https://images.unsplash.com/photo-1535016120754-fd45c1d4a1f9?w=500&h=300&fit=crop",
    category: "gaming",
    verified: true,
  },
  {
...
const mockShorts = [
  ...
  },
  {
    ...
    duration: "0:30",
    thumbnail:
      "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=500&h=800&fit=crop",
    channel: "@CSSMaster",
    views: "1.8M",
    category: "coding",
  },
  ...
  },
  {
    ...
    duration: "0:42",
    thumbnail:
      "https://images.unsplash.com/photo-1535016120754-fd45c1d4a1f9?w=500&h=800&fit=crop",
    channel: "@ProGamer",
    views: "2.4M",
    category: "gaming",
  },
  {
    ...
    duration: "0:48",
    thumbnail:
      "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=500&h=800&fit=crop",
    channel: "@MusicPro",
    views: "1.2M",
    category: "music",
  },
  {
    ...
    duration: "0:55",
    thumbnail:
      "https://images.unsplash.com/photo-1517836357463-d25ddfcbf042?w=500&h=800&fit=crop",
    channel: "@FitLife",
    views: "2.8M",
    category: "fitness",
  },
  {
    ...
    duration: "0:52",
    thumbnail:
      "https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=500&h=800&fit=crop",
    channel: "@Wanderlust",
    views: "1.9M",
    category: "travel",
  },
  {
    ...
    duration: "0:38",
    thumbnail:
      "https://images.unsplash.com/photo-1495521821757-a1efb6729352?w=500&h=800&fit=crop",
    channel: "@FoodieLife",
    views: "3.5M",
    category: "food",
  },
  {
    ...
    duration: "0:44",
    thumbnail:
      "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&h=800&fit=crop",
    channel: "@StyleGoal",
    views: "2.2M",
    category: "fashion",
  },
  ...
  },
  {
    ...
    duration: "0:41",
    thumbnail:
      "https://images.unsplash.com/photo-1561070791-2526d30994b5?w=500&h=800&fit=crop",
  ...
  },
  {
    ...
    duration: "0:47",
    thumbnail:
      "https://images.unsplash.com/photo-1617638924702-92f37fcb0f33?w=500&h=800&fit=crop",
    channel: "@PhotoPro",
    views: "2.6M",
  ...
  },
  {
    ...
    duration: "0:46",
    thumbnail:
      "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=500&h=800&fit=crop",
    channel: "@DanceVibes",
    views: "4.3M",
    category: "dance",
  },
  ...
  },
  {
    ...
    duration: "0:49",
    thumbnail:
      "https://images.unsplash.com/photo-1489599810694-b5473e7eb244?w=500&h=800&fit=crop",
    channel: "@AnimeLounge",
    views: "3.4M",
    category: "anime",
  },
...
const Home = () => {
  ...
  const [shortsOffsets, setShortsOffsets] = useState({
    row2: 0,
    row5: 0,
    row8: 0,
    row10: 0,
  ...
  // ✅ FIXED - Now only includes selectedCategory in dependency array
  useEffect(() => {
  ...
  }, [selectedCategory]); // ✅ NO WARNING - mockVideos is outside component
        ...
        <div className="shorts-header">
          ...
          <div className="carousel-buttons">
            ...
            <button
              ...
              disabled={
                (shortsOffsets[rowKey] || startIndex) >= mockShorts.length - 5
              }
              title="Next shorts"
            >
