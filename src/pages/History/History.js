...
const mockHistoryData = [
  {
    ...
    timestamp: new Date(),
    thumbnail:
      "https://images.unsplash.com/photo-1578375050575-5b21e3f3f7a5?w=300&h=170&fit=crop",
    type: "shorts",
    duration: "0:45",
  },
  {
    ...
    timestamp: new Date(),
    thumbnail:
      "https://images.unsplash.com/photo-1577720643272-265f434e498a?w=300&h=170&fit=crop",
    type: "shorts",
    duration: "0:58",
  },
  {
    ...
    timestamp: new Date(),
    thumbnail:
      "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=300&h=170&fit=crop",
    type: "shorts",
    duration: "0:52",
  },
  {
    ...
    timestamp: new Date(),
    thumbnail:
      "https://images.unsplash.com/photo-1511379938547-c1f69b13d835?w=300&h=170&fit=crop",
    type: "shorts",
    duration: "1:05",
  },
  {
    id: 5,
    title:
      "Pov: That One Poor Friend 🍌😂 - Ekaki Edit | VAI VAI TRAIR (Slowed) | #ekaki #shorts",
    channel: "PS Edits",
    views: "2.3M",
    date: "Saturday",
    timestamp: new Date(Date.now() - 86400000),
    thumbnail:
      "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=300&h=170&fit=crop",
    type: "video",
    duration: "8:45",
  },
  {
    ...
    thumbnail:
      "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=300&h=170&fit=crop",
    type: "video",
    duration: "12:30",
  },
  {
    ...
    thumbnail:
      "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=300&h=170&fit=crop",
    type: "music",
    duration: "45:20",
  },
  {
...
const History = () => {
  ...
  }, []); // ✅ No warning - mockHistoryData is now outside!
    ...
    <div className="history-container">
      ...
      <div className="history-controls">
        ...
        {selectedItems.size > 0 && (
          <button
            className="control-btn delete-selected-btn"
        ...
        <div className="modal-overlay" onClick={() => setShowClearModal(false)}>
          <div className="modal-box" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-content">
              <p>
                This will delete all your watch history. You can undo this
                action.
              </p>
